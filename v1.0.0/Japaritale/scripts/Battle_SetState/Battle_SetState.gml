...
function Battle_SetState() {
	...
	if(STATE==BATTLE_STATE.TURN_PREPARATION){
		...
		var MOVE_TWEEN=Battle_GetTurnInfo(BATTLE_TURN.BOARD_MOVE_TWEEN,ANIM_TWEEN.CIRC);
		...
		var MOVE_SPEED=Battle_GetTurnInfo(BATTLE_TURN.BOARD_MOVE_SPEED,7);
		var MOVE_DURATION=Battle_GetTurnInfo(BATTLE_TURN.BOARD_MOVE_DURATION,30);
		var SIZE_TWEEN=Battle_GetTurnInfo(BATTLE_TURN.BOARD_SIZE_TWEEN,ANIM_TWEEN.CIRC);
		...
		var SIZE_SPEED=Battle_GetTurnInfo(BATTLE_TURN.BOARD_SIZE_SPEED,7);
	...
	if(STATE==BATTLE_STATE.BOARD_RESETTING){
		...
		var MOVE_TWEEN=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_MOVE_TWEEN,ANIM_TWEEN.CIRC);
		...
		var MOVE_SPEED=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_MOVE_SPEED,7);
		var MOVE_DURATION=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_MOVE_DURATION,30);
		var SIZE_TWEEN=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_SIZE_TWEEN,ANIM_TWEEN.CIRC);
		...
		var SIZE_SPEED=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_SIZE_SPEED,7);
