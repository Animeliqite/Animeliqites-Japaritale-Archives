...
Anim_Create(id,"_pirannah_opening_amount",ANIM_TWEEN.SINE,ANIM_EASE.IN_OUT,0,45,15,15,-1,-1,ANIM_MODE.ONESHOT,false);
Anim_Create(id,"_vine_length",ANIM_TWEEN.SINE,ANIM_EASE.IN_OUT,point_distance(x,y,battle_board.x,battle_board.y)/1.75-60,300,5,30,-1,-1,ANIM_MODE.ONESHOT,true);
