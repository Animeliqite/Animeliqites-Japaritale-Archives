...
if(STATE==BATTLE_STATE.MENU) {
	_inst_frame_up.block_enabled=false;
	_inst_frame_down.block_enabled=false;
	_inst_frame_left.block_enabled=false;
	_inst_frame_right.block_enabled=false;
}
else if(STATE==BATTLE_STATE.IN_TURN||STATE==BATTLE_STATE.TURN_PREPARATION){
	_inst_frame_up.block_enabled=true;
	_inst_frame_down.block_enabled=true;
	_inst_frame_left.block_enabled=true;
	_inst_frame_right.block_enabled=true;
}

_angle=angle;
//背景
_point_x=((x-left)+(x+right))/2;
_point_y=((y-up)+(y+down))/2;
event_user(0);
_bg_x=_point_x;
_bg_y=_point_y;
