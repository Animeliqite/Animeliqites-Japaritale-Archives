...
if(keyboard_check_pressed(vk_f1)&&GAME_DEBUG){
	global.debug_menu=!global.debug_menu;
	show_debug_overlay(global.debug_menu,true);
}

if(keyboard_check_pressed(vk_escape)&&!instance_exists(ui_quitting)){
	instance_create_depth(0,0,-2500,ui_quitting);
}
