...
_handler_obj=Encounter_GetHandlerObject(ENCOUNTER);

_menu_button_cutscene_func=false;
_menu_button_cutscene_func_method=undefined;
...
_item_action=array_create(1,{text: "Item Name", onUse: function () { Battle_EndMenu(); }});
_item_action_selection=0;
_item_action_cancellable=true;
_menu_choice_item_action=0;
_menu_choice_item_action_first=0;
_menu_item_slot_type=array_create(8,"ITEM");