...
Battle_SetEnemyName(_enemy_slot,Lang_GetString("monster.cellien_big.name"));
...
_battle_lastturn=battle_turn_pirannah_variation_0;

_has_used_paperplane=false;
...
_paperplane_not_used=-1;
_paperplane_not_thrown=0;

_cutscene_serval_inform=false;

battle_button_fight.sprite_index=Lang_GetSprite("battle.button.fight.empty",spr_default);
