image_yscale=1;
Anim_Create(id,"image_index",0,0,0,3,3);
Anim_Create(id,"_beam_scale",0,0,0,_beam_scale_default,8);

audio_stop_sound(snd_gb_release);
audio_play_sound_on(global._gmu_emitter_sfx,snd_gb_release,0,0);

audio_stop_sound(snd_gb_release2);
var sid=audio_play_sound_on(global._gmu_emitter_sfx,snd_gb_release2,0,0);
